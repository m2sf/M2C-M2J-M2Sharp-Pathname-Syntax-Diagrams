...
#   ;
#
lappend non_terminals vms_pathname {
  or 
	relativePath
	absolutePath
    fileNameOnly
...
#   headComponent '::'
#   ; 
lappend non_terminals vms_node {
  line headcomponent ::
}
...
#   '[' dirPath ']'
#   ; 
lappend non_terminals vms_directory {
  line [ dirPath ]
}
...
#   '.' dirPath
#   ; 
lappend non_terminals vms_childPath {
  line . dirPath
}
...
#   ;
lappend terminals vms_HeadComponentChar {
  or 
    HeadComponentChar
	0..9
}

# (2) Head Component Lead Character
#
# HeadLeadComponentChar :=
#   'a' .. 'z' | 'A' .. 'Z' | '$' | '_'
#   ;
lappend terminals vms_HeadComponentLeadChar {
  or 
    a..z
	A..Z
	$
...
# (3) Tail Component Character
#
# TailComponentChar :=
#   TailComponentLeadChar | '-'
#   ;
lappend terminals vms_TailComponentChar {
  or
    TailComponentLeadChar
	-
}

# (4) Tail Component Lead Character
#
# TailComponentLeadChar :=
#   'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '$' | '_'
#   ;
lappend terminals vms_TailComponentLeadChar {
  or
    a..z
    A..Z
    0..9
