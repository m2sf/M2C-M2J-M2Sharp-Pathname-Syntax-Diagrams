...
#   '\\' ComponentLeadChar+
#   ; 
lappend non_terminals win_server {
  line  \\\\ {loop {line ComponentLeadChar } }
}
...
# 
lappend non_terminals win_filenameOnly {
  line pathComponent
}
...
#   ComponentLeadChar | '-' | '~'
#   ;
lappend terminals win_ComponentChar {
  or 
    ComponentLeadChar
    -
    ~
...
#   'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_'
#   ;
lappend terminals win_ComponentLeadChar {
  or
    a..z
    A..Z
    0..9
